...
Patch0007:      specifies-the-ovs-module-path.patch
Patch0008:      change-the-name-of-the-ipsec-configuration-file.patch
...
%changelog
* Mon Jul 25 2022 zhouwenpei <zhouwenpei1@h-pattners.com> - 2.12.0-18
- Type:bugfix
- ID:NA
- SUG:NA
